...
public class Smartphone {
    ...
    public Smartphone(String smartphone_mark, double smartphone_price, String smartphone_status, String smartphone_system, double smartphone_screen_diagonal, double smartphone_disc_size, double smartphone_ram_size, int smartphone_camera_resolution, int smartphone_amount_available, Set<OrderSmartphone> orderSmartphone) {
        this.smartphone_mark = smartphone_mark;
        this.smartphone_price = smartphone_price;
        this.smartphone_status = smartphone_status;
        this.smartphone_system = smartphone_system;
